...
import it.unimi.di.sweng.esame.presenter.DelayPresenter;
import it.unimi.di.sweng.esame.presenter.DeparturePresenter;
import it.unimi.di.sweng.esame.presenter.SortTrainStrategy;
...
public class Main extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    DelayPresenter delayPresenter = new DelayPresenter(model, input);
    DeparturePresenter departurePresenter = new DeparturePresenter(model, command[0], command[1], new SortTrainStrategy());
